...
namespace <xsl:value-of select="$namespace"/>.Client.Services
{
    ...
    using <xsl:value-of select="$namespace"/>.Business;
    using System;
  ...
  <xsl:template match="Operation">
    <xsl:choose>
      ...
      <xsl:when test="@httpMethod='HttpPut'"><xsl:call-template name="http_post_template"/></xsl:when>
      <xsl:when test="@httpMethod='HttpDelete'"><xsl:call-template name="http_post_template"/></xsl:when>
