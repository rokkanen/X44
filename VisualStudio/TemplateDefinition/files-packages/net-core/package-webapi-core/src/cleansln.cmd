...
for /D %%I in (".\Faker*") do rmdir %%I\bin /s/q
for /D %%I in (".\Faker*") do rmdir %%I\obj /s/q
for /D %%I in (".\Faker*") do attrib -H %%I\StyleCop.Cache
for /D %%I in (".\Faker*") do del %%I\StyleCop.Cache
