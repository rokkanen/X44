...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template name="Entity">
    ...
    <xsl:apply-templates select="RelationShips/RelationShip" mode="properties"/>
      <!-- 
    <xsl:apply-templates select="RelationShips/RelationShip[@relationType='one-to-many']" mode="method"/>
    <xsl:apply-templates select="RelationShips/RelationShip[@relationType='many-to-many']" mode="method"/> !-->
    }
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template match="RelationShip" mode="properties">
...
namespace <xsl:value-of select="$namespace"/>.Client.Model
{
    using System;
